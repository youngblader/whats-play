...
export const ShareIcon: FC<IconProps> = memo(function ShareIcon({ color = Colors.white, size = boxWidth, style }) {
  return (
    <Svg style={style} width={size} height={size * ratio} viewBox="0 0 24 24">
      <Path
        fill={color}
